...
export declare class TratamentoErroCoreService {
  ...
  private logger;
  constructor(
    identificaErroService: IdentificaErroCoreService,
    notificaErroGuardiaoService: NotificaErroGuardiaoCoreService,
    registraErroMongoService: RegistraErroMongoCoreService,
    tratarErros: TratarErrosCoreService,
  );
