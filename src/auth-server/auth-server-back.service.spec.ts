...
describe('AuthServerBackService', () => {
  ...
  beforeEach(() => {
    ...
    service = new AuthServerBackService(options, cache);
  ...
  describe('validateToken', () => {
    ...
    it.each([
      {
        typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/introspect').passThrough(),
        message: 'Pass Through',
      },
      {
        typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/introspect').abortRequest(),
        message: 'Abort Request',
      },
      {
        typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/introspect').timeout(),
        message: 'Timeout',
      },
      {
        typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/introspect').networkError(),
        message: 'Network Error',
      },
      {
        typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/introspect').reply(401),
        message: 'HTTP 401',
      },
      {
        typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/introspect').reply(400),
        message: 'HTTP 400',
      },
      {
        typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/introspect').reply(500),
        message: 'HTTP 500',
      },
      {
        typeErro: () =>
  ...
  describe('getTokenForce', () => {
    ...
    it.each([
      {
        typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/auth').passThrough(),
        message: 'Pass Through',
      },
      {
        typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/auth').abortRequest(),
        message: 'Abort Request',
      },
      { typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/auth').timeout(), message: 'Timeout' },
      {
        typeErro: () => mockAxios.onPost(options.authServerUrl + '/system-user/auth').networkError(),
        message: 'Network Error',
      },
