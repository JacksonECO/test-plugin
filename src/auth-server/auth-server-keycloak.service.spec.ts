...
describe("AuthServerKeycloakService", () => {
  ...
  beforeEach(() => {
    ...
    service = new AuthServerKeycloakService(
      options,
      cache,
    );
  ...
  describe("validateToken", () => {
    ...
    it.each([
      ...
      { typeErro: () => mockAxios.onPost(urlIntrospect).reply(() => { throw 'error' }), message: "Error" },
    ])
  ...
  describe("getTokenForce", () => {
    ...
    it.each([
      ...
      { typeErro: () => mockAxios.onPost(urlAuth).reply(() => { throw 'error' }), message: "Error" },
