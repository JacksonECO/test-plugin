...
describe('LogRequestInterceptor', () => {
  ...
  let logService: Mocked<Pick<LogCoreService, 'salvarRequest'>>;
  let contextCoreService: Mocked<Pick<ContextCoreService, 'set'>>;
  let reflector: Reflector;

  beforeEach(() => {
    logService = { salvarRequest: vi.fn() };
    contextCoreService = { set: vi.fn() };
  ...
  function mockLogCustom(options?: LogCustomOptions) {
    vi.spyOn(reflector, 'getAllAndOverride').mockImplementation((key) =>
      key === META_LOG_CUSTOM ? options : undefined,
    );
  }

  describe('sucesso', () => {
    it('loga request e response normalmente quando não há LogCustom', () => {
    ...
    it('remove campos do request quando excluirCampoRequest é configurado', () => {
      return new Promise<void>((done) => {
    ...
    it('remove campos do response quando excluirCampoResponse é configurado', () => {
      return new Promise<void>((done) => {
        mockLogCustom({ excluirCampoResponse: ['token'] });
        const request = { method: 'GET', path: '/x' };

        interceptor
          .intercept(buildContext(request), buildCallHandler(of({ token: 'abc', nome: 'x' })))
          .subscribe(() => {
    ...
    it('mascara campos do request quando mascararCampoRequest é configurado', () => {
      return new Promise<void>((done) => {
    ...
    it('mascara campos do response quando mascararCampoResponse é configurado', () => {
      return new Promise<void>((done) => {
    ...
    it('não loga o request inteiro quando excluirRequest é true', () => {
      return new Promise<void>((done) => {
    ...
    it('não loga o response inteiro quando excluirResponse é true', () => {
      return new Promise<void>((done) => {
    ...
    it('não loga o response quando salvarResponseSucesso é false e a requisição foi bem-sucedida', () => {
      return new Promise<void>((done) => {
    ...
    it('não persiste log nenhum quando salvarSucesso é false e a requisição foi bem-sucedida', () => {
      return new Promise<void>((done) => {
    ...
    it('persiste tipo e mensagem customizados quando configurados', () => {
      return new Promise<void>((done) => {
  ...
  describe('ip e correlationId', () => {
    ...
    it('não captura ip nem correlationId quando a config está desligada', () => {
      return new Promise<void>((done) => {
        mockLogCustom(undefined);
    ...
    it('captura o ip da request quando salvarIp está ligado', () => {
      return new Promise<void>((done) => {
    ...
    it('captura o correlationId do header e propaga no contexto', () => {
      return new Promise<void>((done) => {
    ...
    it('lê o correlationId do header configurado em correlationIdHeader', () => {
      return new Promise<void>((done) => {
    ...
    it('mantém ip e correlationId no fluxo de erro', () => {
      return new Promise<void>((done) => {
  ...
  describe('erro', () => {
    it('remove campos do request também no fluxo de erro', () => {
      return new Promise<void>((done) => {
        mockLogCustom({ excluirCampoRequest: ['body.password'] });
        const request = { method: 'POST', path: '/x', body: { password: 'segredo', username: 'user1' } };
        const error: any = new Error('falhou');
    ...
    it('ainda relança o erro original após logar', () => {
      return new Promise<void>((done) => {
        mockLogCustom(undefined);
    ...
    it('loga o response do erro mesmo com salvarResponseSucesso false', () => {
      return new Promise<void>((done) => {
        mockLogCustom({ salvarResponseSucesso: false });
        const request = { method: 'POST', path: '/x' };
        const error: any = new Error('falhou');
    ...
    it('loga o erro mesmo com salvarSucesso false', () => {
      return new Promise<void>((done) => {
        mockLogCustom({ salvarSucesso: false });
        const request = { method: 'POST', path: '/x' };
        const error: any = new Error('falhou');
